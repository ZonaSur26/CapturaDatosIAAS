...
def render():
    ...
    if hemocultivo_its == "Sí":
        s_periferica = st.radio("SANGRE PERIFÉRICA", ["No", "Sí"], horizontal=True)
        s_cateter = st.radio("SANGRE POR CATETÉR CENTRAL", ["No", "Sí"], horizontal=True)
        p_cateter = st.radio("PUNTA DE CATETÉR CENTRAL", ["No", "Sí"], horizontal=True)
